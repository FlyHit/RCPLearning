 ...
 * and navigation.
 */
public class CAdaptableList implements IWorkbenchAdapter, IAdaptable {
    protected List children = new ArrayList();

    /**
     * Creates a new adaptable list with the given children.
     */
    public CAdaptableList() {
    }

    /**
     * Creates a new adaptable list with the given children.
     */
    public CAdaptableList(IAdaptable[] newChildren) {
     ...
     * Returns this list.
     */
    public CAdaptableList add(Iterator iterator) {
     ...
     * Returns this list.
     */
    public CAdaptableList add(IAdaptable adaptable) {
